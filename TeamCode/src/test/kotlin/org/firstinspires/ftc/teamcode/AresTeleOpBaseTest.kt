...
class AresTeleOpBaseTest {
    ...
    @Test
    fun testGamepadDefaultStateConversion() {
        val gamepad = Gamepad()

        val stateFromToState = gamepad.toState()
        assertEquals(0.0f, stateFromToState.leftStickX, 1e-4f)
        assertEquals(0.0f, stateFromToState.leftStickY, 1e-4f)
        assertEquals(0.0f, stateFromToState.rightStickX, 1e-4f)
        assertEquals(0.0f, stateFromToState.rightStickY, 1e-4f)
        assertEquals(0.0f, stateFromToState.leftTrigger, 1e-4f)
        assertEquals(0.0f, stateFromToState.rightTrigger, 1e-4f)
        assertFalse(stateFromToState.a)
        assertFalse(stateFromToState.b)
        assertFalse(stateFromToState.x)
        assertFalse(stateFromToState.y)
        assertFalse(stateFromToState.dpadUp)
        assertFalse(stateFromToState.dpadDown)
        assertFalse(stateFromToState.dpadLeft)
        assertFalse(stateFromToState.dpadRight)
        assertFalse(stateFromToState.leftBumper)
        assertFalse(stateFromToState.rightBumper)
        assertFalse(stateFromToState.leftStickButton)
        assertFalse(stateFromToState.rightStickButton)
        assertFalse(stateFromToState.start)
        assertFalse(stateFromToState.back)

        val stateFromUpdate = GamepadState()
        stateFromUpdate.update(gamepad)
        assertEquals(0.0f, stateFromUpdate.leftStickX, 1e-4f)
        assertEquals(0.0f, stateFromUpdate.leftStickY, 1e-4f)
        assertEquals(0.0f, stateFromUpdate.rightStickX, 1e-4f)
        assertEquals(0.0f, stateFromUpdate.rightStickY, 1e-4f)
        assertEquals(0.0f, stateFromUpdate.leftTrigger, 1e-4f)
        assertEquals(0.0f, stateFromUpdate.rightTrigger, 1e-4f)
        assertFalse(stateFromUpdate.a)
        assertFalse(stateFromUpdate.b)
        assertFalse(stateFromUpdate.x)
        assertFalse(stateFromUpdate.y)
        assertFalse(stateFromUpdate.dpadUp)
        assertFalse(stateFromUpdate.dpadDown)
        assertFalse(stateFromUpdate.dpadLeft)
        assertFalse(stateFromUpdate.dpadRight)
        assertFalse(stateFromUpdate.leftBumper)
        assertFalse(stateFromUpdate.rightBumper)
        assertFalse(stateFromUpdate.leftStickButton)
        assertFalse(stateFromUpdate.rightStickButton)
        assertFalse(stateFromUpdate.start)
        assertFalse(stateFromUpdate.back)
    }
}
